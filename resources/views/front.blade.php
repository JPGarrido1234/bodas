...
<body>
    ...
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-container" style="margin-left:0;width:100%">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="page-description d-flex align-items-center @hasSection('tabs') page-description-tabbed @endif">
                                    <div class="page-description-content float-none d-sm-flex justify-content-between align-items-end w-100">
                                        <img id="logo-front" class="text-sm-center" src="https://bodegascampos.com/wp-content/uploads/2022/10/logo-web-transparente.png" style="max-width:220px">
