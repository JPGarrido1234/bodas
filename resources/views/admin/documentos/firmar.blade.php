...
@section('content')
    <div class="row">
        ...
        <div class="d-block d-md-none col-12 text-center">
            ...
            <p><a target="_self" href="{{ viewPDF('/storage/contratos/' . $boda->id . '/' . $doc_sign->doc_id . '.pdf') }}"
                    class="btn btn-outline-primary">Descargar <b>{!! $doc_sign->doc->name !!}</b></a></p>
    ...
    <div style="width: 100%;display:block;text-align:center">
        <br>
        <form action="{!! route('user.documentos.firmar.sign') !!}" method="POST">
            <div class="form-check">
                <input class="form-check-input" style="float:inherit" type="checkbox" value="" id="flexCheckDefault"
                    required>
            ...
            <input type="hidden" name="boda_id" value="{!! $doc_sign->boda_id !!}">
...
@section('js')
    ...
    <script>
        ...
        async function fillForm() {
            ...
            const formUrl = '{!! '/storage/contratos/' . $boda->id . '/' . $doc_sign->doc_id . '.pdf' !!}';
